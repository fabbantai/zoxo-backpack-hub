      ...
      <div className="zoxo-container px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed opacity-70 mb-6">
              Designed for modern lifestyles. Combining style, comfort & durability for everyday journeys.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                { label: 'Kids Collection', to: '/c/kids-backpacks' },
                { label: 'College Bags', to: '/c/college-backpacks' },
        ...
        <div className="border-t border-primary-foreground/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4 text-xs opacity-50">
            <span>🛍️ Trusted Meesho Checkout</span>
            <span>📦 Fast Delivery by Sellers</span>
